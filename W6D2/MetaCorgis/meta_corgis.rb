...
class MetaCorgiSnacks
  ...
  #   method_name_1 = ("get_#{name.to_s}_info").to_sym
  #   method_name_2 = ("get_#{name.to_s}_tastiness").to_sym
  #   info = @snack_box.send(method_name_1, @box_id)
  #   tastiness = @snack_box.send(method_name_2, @box_id)
  #   result = "Treat: #{info}: #{tastiness} "
  #   tastiness > 30 ? "* #{result}" : result
  # end
